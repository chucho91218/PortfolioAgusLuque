...
export function PrinciplesSection() {
  ...
  const principles = [
    ...
    },
    {
      ...
      description: "Planifico por tareas cortas, iteración y entrega constante. Comunicación clara y orden.",
      align: "left",
    },
    {
      number: "04",
      ...
      description: "Sumo desde el lado humano: buena energía, respeto, paciencia y ganas de colaborar.",
      align: "right",
    },
  ]
